...
Десктопний застосунок для створення, візуалізації та проходження лабіринтів. Програма дозволяє одночасно генерувати до трьох лабіринтів із різними параметрами та алгоритмами. :contentReference[oaicite:0]{index=0}
